...
const TopicUnderstanding = () => {
  ...
  const searchStages = [
    ...
    },
    {
      id: "wikipedia",
      name: "Wikipedia",
      description: "Academic definitions",
      icon: Book,
      ...
      <div className="flex flex-col items-center justify-center min-h-96 py-8">
        ...
        <div className="relative mb-12">
          ...
          <div className="relative w-24 h-24">
            ...
            <div className="absolute inset-2 border-4 border-purple-500/40 rounded-full animate-ping" style={{ animationDelay: '0.5s' }}></div>
            <div className="absolute inset-4 border-4 border-pink-500/50 rounded-full animate-ping" style={{ animationDelay: '1s' }}></div>
            ...
            <div className="absolute inset-0 rounded-full bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 animate-spin">
              <div className="absolute inset-2 rounded-full bg-black flex items-center justify-center">
                <div className="w-4 h-4 bg-gradient-to-r from-blue-500 to-pink-500 rounded-full animate-pulse"></div>
              </div>
            </div>
            ...
            {[...Array(8)].map((_, i) => (
              <div
                ...
                style={{
                  top: `${Math.sin((i * Math.PI) / 4) * 40 + 40}%`,
                  left: `${Math.cos((i * Math.PI) / 4) * 40 + 40}%`,
        ...
        <div className="w-full max-w-4xl px-4">
          ...
          <div className="relative mb-8">
            ...
            <div 
              className="absolute top-1/2 left-0 h-1 bg-gradient-to-r from-blue-500 to-purple-500 transform -translate-y-1/2 rounded-full transition-all duration-1000 ease-out"
              style={{ 
                width: `${(searchProgress.length / searchStages.length) * 100}%` 
              }}
            >
              {/* Moving Glow */}
              <div className="absolute right-0 top-1/2 w-4 h-4 bg-purple-500 rounded-full transform -translate-y-1/2 shadow-lg shadow-purple-500/50 animate-pulse"></div>
            </div>
          </div>
              ...
              return (
                <div key={stage.id} className="relative">
                  ...
                  <div className="relative z-10 flex flex-col items-center">
                    {/* Connection Line (for completed stages) */}
                    {index > 0 && (
                      <div 
                        className={`absolute top-4 -left-1/2 w-full h-0.5 transition-all duration-500 ${
                          isCompleted ? 'bg-gradient-to-r from-blue-500 to-purple-500' : 'bg-gray-700'
                        }`}
                      />
                    )}
                    ...
                    {/* Stage Circle */}
                    <div
                      className={`w-8 h-8 rounded-full flex items-center justify-center mb-2 transition-all duration-500 transform ${
                        isActive
                          ? `scale-125 bg-gradient-to-r ${stage.gradient} shadow-lg ${stage.bgColor.replace('bg-', 'shadow-')}/50`
                          : isCompleted
                          ? `bg-gradient-to-r ${stage.gradient} shadow-md`
                    ...
                    <div className="text-center">
                      <div className={`text-xs font-semibold transition-colors ${
                        isActive ? stage.color : isCompleted ? "text-white" : "text-gray-500"
                      }`}>
                        {stage.name}
                      </div>
                    ...
                    {isActive && (
                      <>
                        {/* Pulsing Ring */}
                        <div className="absolute top-0 w-8 h-8 border-2 border-blue-400 rounded-full animate-ping"></div>
        ...
        <div className="mt-8 text-center">
          <div className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
            {Math.round((searchProgress.length / searchStages.length) * 100)}%
          </div>
          <p className="text-gray-400 text-sm mt-1">
            {currentStage && `Currently: ${searchStages.find(s => s.id === currentStage)?.name}`}
          </p>
        </div>
      </div>
    );
